 ...
 * 
 * @method void afterSave( Request $request, \Gomee\Models\Model $result )
 * @method void afterAjaxSave( Request $request, \Gomee\Models\Model $result )
 * @method void afterCreate( Request $request, \Gomee\Models\Model $result ) 
 * @method void afterAjaxCreate( Request $request, \Gomee\Models\Model $result ) 
 * @method void afterStore( Request $request, \Gomee\Models\Model $result ) 
 * @method void afterUpdate( Request $request, \Gomee\Models\Model $result ) 
 * @method void afterAjaxUpdate( Request $request, \Gomee\Models\Model $result ) 
 * @method void afterMoveToTrash( Request $request, \Gomee\Models\Model $result ) 
 * @method void afterRestore( Request $request, \Gomee\Models\Model $result )
 * @method void afterDelete( Request $request, \Gomee\Models\Model $result )
 * 
